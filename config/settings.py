...
SPECTACULAR_SETTINGS = {
    ...
    "TAGS": [
        ...
        {"name": "3.1.1.2 Удобства в номере", "description": "Методы для работы с удобствами в номерах отелей"},
        {"name": "3.1.1.3 Удобства спорт и отдых", "description": "Методы для работы с удобствами спорта и отдыха"},
        {"name": "3.1.1.4 Удобства для детей", "description": "Методы для работы с удобствами для детей"},
