...
class Vzhuh(models.Model):
    ...
    photos = models.ManyToManyField(VzhuhPhoto, verbose_name="Фотографии Вжуха", related_name="vzhuhs", blank=True)
    tours = models.ManyToManyField(Tour, verbose_name="Вжухнутые туры", related_name="vzhuhs", blank=True)
    hotels = models.ManyToManyField(Hotel, verbose_name="Вжухнутые отели", related_name="vzhuhs", blank=True)
    ...
    class Meta:
        ...
        ordering = ["-created_at"]
        indexes = [
            models.Index(fields=["departure_city"]),
        ]
