        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "flight_number",
                    models.CharField(
                        help_text="Введите номер рейса в формате: AA XXXX, или AX XXX, где A-латинские буквы в верхнем регистре, X- цифры",
                        max_length=10,
                ...
                (
                    "departure_date",
                    models.DateField(
                        help_text="Введите дату вылета", verbose_name="Дата вылета"
                    ),
                ),
                (
                    "departure_time",
                    models.TimeField(
                        help_text="Введите время вылета", verbose_name="Время вылета"
                    ),
                ),
                (
                    "arrival_date",
                    models.DateField(
                        help_text="Введите дату прибытия", verbose_name="Дата прибытия"
                    ),
                ),
                (
                    "arrival_time",
