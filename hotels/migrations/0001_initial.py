    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "photo",
                    models.ImageField(
                        upload_to="hotels/", verbose_name="Фотография отеля"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "nightly_price",
                    models.PositiveIntegerField(verbose_name="Цена за ночь"),
                ),
            ],
            options={
                "verbose_name": "Номер",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "photo",
                    models.ImageField(
                        upload_to="hotels/rooms/", verbose_name="Фотография номера"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "room",
                    models.ManyToManyField(
                        blank=True, to="hotels.room", verbose_name="Номера в отеле"
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, to="hotels.roomamenity", verbose_name="Удобства в номере"
            ),
        ),
        migrations.AddField(
            model_name="room",
        ...
        migrations.AddField(
            ...
            name="photos",
            field=models.ManyToManyField(
                blank=True, to="hotels.roomphoto", verbose_name="Фотографии номера"
            ),
        ),
    ]
