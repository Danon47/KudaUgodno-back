    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_rating', models.FloatField(blank=True, default=0.0, help_text='Пользовательская оценка', null=True, validators=[django.core.validators.MinValueValidator(Decimal('0.0')), django.core.validators.MaxValueValidator(Decimal('10.0'))], verbose_name='Пользовательская оценка')),
                ...
                ('width', models.FloatField(blank=True, default='45.554477', help_text='Широта (от -90 до 90)', null=True, validators=[django.core.validators.MinValueValidator(Decimal('-90.0')), django.core.validators.MaxValueValidator(Decimal('90.0'))], verbose_name='Широта')),
                ('longitude', models.FloatField(blank=True, default='39.833333', help_text='Долгота (от -180 до 180)', null=True, validators=[django.core.validators.MinValueValidator(Decimal('-180.0')), django.core.validators.MaxValueValidator(Decimal('180.0'))], verbose_name='Долгота')),
            ],
            options={
                'verbose_name': 'Отель',
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['hotel', 'name'], name='hotels_type_hotel_i_ddef4c_idx')],
