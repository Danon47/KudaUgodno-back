    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["hotel", "name"], name="hotels_type_hotel_i_ddef4c_idx"
                    )
                ],
                "constraints": [
                    models.UniqueConstraint(
                        fields=("hotel", "name"), name="unique_type_of_meal_in_hotel"
                    )
                ],
            },
        ),
