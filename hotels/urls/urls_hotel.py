...
# from hotels.views.hotel.views_hotel_amenity import (
#     HotelAmenityCommonViewSet,
#     HotelAmenityInTheRoomViewSet,
#     HotelAmenitySportsAndRecreationViewSet,
#     HotelAmenityForChildrenViewSet,
# )
...
urlpatterns = [
    ...
    #     HotelAmenityCommonViewSet.as_view({"get": "list", "post": "create"}),
    ...
    #     HotelAmenityInTheRoomViewSet.as_view({"get": "list", "post": "create"}),
    ...
    #     HotelAmenityForChildrenViewSet.as_view({"get": "list", "post": "create"}),
    ...
    # path(
    #     "hotels/rules/",
    #     HotelRulesViewSet.as_view({"get": "list", "post": "create"}),
    #     name="hotels-rules",
    # ),
