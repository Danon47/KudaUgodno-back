...
@extend_schema_view(
    create=extend_schema(
        ...
        description="Создание нового удобства для отеля",
        request=AmenityHotelSerializer,
        responses={
            201: AmenityHotelSerializer,
            400: OpenApiResponse(description="Ошибка валидации"),
        },
        tags=["3. Отель"],
    )
)
class HotelAmenityViewSet(mixins.CreateModelMixin, viewsets.GenericViewSet):
    queryset = HotelAmenity.objects.all()
    serializer_class = AmenityHotelSerializer
...
@extend_schema_view(
    create=extend_schema(
        ...
        description="Загрузка фотографий для отеля",
        request=HotelPhotoSerializer,
        responses={
...
class HotelPhotoViewSet(mixins.CreateModelMixin, viewsets.GenericViewSet):
    queryset = HotelPhoto.objects.all()
    serializer_class = HotelPhotoSerializer
